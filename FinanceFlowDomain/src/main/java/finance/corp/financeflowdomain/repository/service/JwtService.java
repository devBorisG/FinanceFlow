package finance.corp.financeflowdomain.repository.service;
...
public class JwtService {
    ...
    public <T> T extractClaim(String token, Function<Claims,T> claimsManager){
        final Claims claims = extractAllClaims(token);
        return claimsManager.apply(claims);
    }
