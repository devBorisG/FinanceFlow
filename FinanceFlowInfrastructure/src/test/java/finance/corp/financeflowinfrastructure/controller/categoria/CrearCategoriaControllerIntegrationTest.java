...
public class CrearCategoriaControllerIntegrationTest {
    ...
    void CrearCategoriaTest_Success() throws Exception {
        ...
        String categoriaJson = "{ \"nombre\": \"Nueva Categoria\", \"descripcion\": \"Descripción de la categoría\", \"usuario\": { \"id\": \"" + id.toString() + "\", \"nombre\": \"Nombre del usuario\", \"email\": \"email@example.com\" } }";
